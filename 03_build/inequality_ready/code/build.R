...
japan_gini <- subset(long_gini_data,long_gini_data$contry=="JPN")
japan_gini
us_gini <- subset(long_gini_data,long_gini_data$contry=="USA")
us_gini
...
convine_japan_us_gini <- us_gini%>%
  full_join(japan_gini)
